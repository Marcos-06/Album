                ...
                <div class="d-flex flex-column h-100">
                  <div
                    ...
                    <img id="imgPrev" height="340"
                         class="w-100"
                         style="object-fit: cover;" src="{{isset($photo->photos_url) ? url("/storage/photos/$photo->photos_url") : asset('/img/img_padrao.png')}}" alt="">
                  </div>
                  <div class="form-group mt-2">
                    <div class="custom-file">
                      <input id="photo" name="photo" type="file" class="custom-file-input" onchange="loadFile(event)" accept="image/png, image/jpg, image/jpng" @empty($photo) required @endempty>
                    </div>
                  </div>
                </div>
